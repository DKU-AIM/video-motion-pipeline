...
아래는 **발표 PPT 7페이지의 원본 개념도**입니다. 농구는 설명용 예시이며 실제 테스트 결과가 아닙니다.
...
점선은 비교할 대안입니다. 두 설명을 합치거나 항상 두 모델을 실행한다는 뜻이 아닙니다. 현재 공유 코드는 단계별 실험 코드이며, 이 전체 흐름을 단일 명령으로 실행하는 통합 시스템은 아직 아닙니다.
