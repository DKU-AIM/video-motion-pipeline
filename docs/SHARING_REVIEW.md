...
- 비공개 팀 저장소: `DKU-AIM/video-motion-pipeline`.
- 2026-09-18 모델별 설치 스크립트 및 새 A100 인스턴스 검증 추가: [실행 가이드](ELICE_GUIDE.md), [검증 기록](ELICE_VALIDATION.md). 다른 GPU/모델 변형과 전이 의존성 전체 잠금은 후속 과제.
